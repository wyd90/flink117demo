    ...
    public static void main(String[] args) throws Exception {
        ...
        waterSensorWithWMDS.keyBy(new KeySelector<WaterSensor, String>() {
            ...
            public String getKey(WaterSensor value) throws Exception {
                ...
                // 当和最后一条数据比较（newDataPoint.getVc() - oldDataPoint.getVc()）（newDataPoint代表最后一条数据，oldDataPoint老数据）
                //如果差值小于2则保留，如果差值大于等于2则剔除
                .evictor(DeltaEvictor.of(2, new DeltaFunction<WaterSensor>() {
                    @Override
                    public double getDelta(WaterSensor oldDataPoint, WaterSensor newDataPoint) {
                        return newDataPoint.getVc() - oldDataPoint.getVc();
                    }
                }))
